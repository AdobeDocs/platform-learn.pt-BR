...
Em seguida, vá para **Conteúdo** e arraste e solte um componente **HTML** na quinta linha. Clique no componente HTML e em **Mostrar o código-fonte**.
...
Vá para **Conteúdo** e arraste e solte um componente **HTML** na sexta linha. Clique no componente HTML e em **Mostrar o código-fonte**.
...
Em seguida, vá para **Conteúdo** e arraste e solte um componente **HTML** na sétima linha. Clique no componente HTML e em **Mostrar o código-fonte**.
