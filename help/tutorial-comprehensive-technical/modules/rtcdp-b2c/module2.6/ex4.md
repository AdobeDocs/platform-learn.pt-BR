...
GET Clique na primeira solicitação, **Conectores disponíveis do Kafka Connect**, para abri-la novamente e clique novamente no botão azul **Enviar**. agora você verá que existe um conector Kafka Connect.
