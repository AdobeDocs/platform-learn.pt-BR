...
* Para **Journey Optimizer**:
   * Para a lição opcional **Campanha da Web**, você deve ter itens de permissão para **[!UICONTROL Gerenciar campanhas]**, **[!UICONTROL Publicar campanhas]** e **[!UICONTROL Exibir relatório de campanhas]**.
  <!--
...
[![Site da Luma](assets/old-overview-luma.png)](https://newluma.enablementadobe.com){target="blank"}
