...
description: Saiba como configurar o Adobe Audience Manager usando o SDK da Web da plataforma e validar a implementação usando um destino de cookie. Esta lição é parte do tutorial Implementar a Adobe Experience Cloud com o SDK da web.
...
![SDK da Web e diagrama do Adobe Audience Manager](assets/dc-websdk-aam.png)
...
A implementação do Audience Manager usando o SDK da Web da Platform é diferente da implementação usando o [encaminhamento pelo lado do servidor (SSF)](https://experienceleague.adobe.com/en/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/report-suite-general/server-side-forwarding/ssf). O encaminhamento pelo lado do servidor passa dados de solicitação Adobe Analytics para o Audience Manager. Uma implementação do SDK da Web da Platform passa dados XDM enviados para o Edge Network da plataforma para o Audience Manager. O Audience Manager está ativado na sequência de dados:
...
1. Abra a [página inicial do Luma](https://luma.enablementadobe.com/content/luma/us/en.html) (mapeada para a propriedade de marca ) e o **Adobe Experience Platform Debugger** e atualize a página.
...
1. Selecione **[!UICONTROL Salvar]** na parte inferior da página
   ...
   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/add-trait-segment.jpg)

   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/saved-segment.jpg)
...
1. Como o **[!UICONTROL Tipo]**, selecione **[!UICONTROL Cookie]**
   ...
   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/destination-settings.jpg)
...
1. Como a opção **[!UICONTROL Dados do Publish para]**, selecione **[!UICONTROL Somente os domínios selecionados]**
...
1. Finalmente, selecione **[!UICONTROL Salvar]** para salvar os detalhes da configuração de destino.
   ...
   ![seção de Configuração de Destino do Audience Manager](assets/aam-destination-config-dw.png)
...
1. Selecionar **[!UICONTROL Concluído]**
   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/luma-cookie-segment-dw.png)
...
1. Abra a [página inicial do site de demonstração Luma](https://luma.enablementadobe.com/content/luma/us/en.html) com ela mapeada para a propriedade de marca para se qualificar para o segmento recém-criado.
...
1. Expanda a **carga** para exibir os detalhes do cookie esperado, conforme configurado anteriormente no Audience Manager. Neste exemplo, você verá o nome de cookie esperado `platform_web_sdk_tutorial`.
   ...
   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/segment-validate-response.jpg)

1. Abra a guia **Aplicativo** e abra **Cookies** no menu **Armazenamento**.
1. Selecione o domínio **`https://luma.enablementadobe.com`** e confirme se seu cookie foi escrito corretamente na lista

   ![Audience Manager Adobe Experience Platform Adicionar Característica](assets/validate-cookie.jpg)
...
![Audience Manager Adobe Experience Platform Adicionar Característica](assets/segment-population.jpg)
