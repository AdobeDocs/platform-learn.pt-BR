...
1. Abra a [página inicial do Luma](https://luma.enablementadobe.com) (mapeada para a propriedade da sua marca) e o **Adobe Experience Platform Debugger** e atualize a página.
...
1. Abra a [página inicial do site de demonstração do Luma](https://luma.enablementadobe.com) com ela mapeada para a propriedade da sua tag para se qualificar para o segmento recém-criado.
