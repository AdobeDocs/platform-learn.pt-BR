...
Neste exercício, você criará um esquema XDM usando os grupos de campos de linha de base recomendados para capturar dados do evento da Web no [site de demonstração do Luma](https://luma.enablementadobe.com){target="_blank"}:
