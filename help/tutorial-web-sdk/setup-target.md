...
>[!NOTE]
>
>Este tutorial usa o [site da Luma](https://luma.enablementadobe.com){target=_blank}, que tem uma implementação assíncrona de tags e mitigação de cintilação em vigor. Esta seção é para referência para entender como a mitigação de cintilação funciona com o Platform Web SDK.
...
1. Navegue até o [site de demonstração Luma](https://luma.enablementadobe.com)
