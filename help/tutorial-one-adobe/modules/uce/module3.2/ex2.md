...
## 3.2.2.3 Criar jornada de fibra

Agora você criará uma jornada. Diferentemente das jornadas baseadas em eventos que dependem dos eventos de experiência recebidos, esta jornada se concentrará na leitura de um público-alvo existente e direcionará todo um público-alvo uma vez com conteúdo exclusivo, como boletins informativos, promoções únicas ou campanhas específicas.

No menu, vá para **Jornadas** e clique em **Criar jornada**.

![Journey Optimizer](./images/campaign1.png)

Na tela de criação da jornada, defina o **Nome** como `--aepUserLdap-- - Fiber`. Clique em **Salvar**.

![Journey Optimizer](./images/campaign2.png)

No menu **Orquestração**, arraste e solte o objeto **Ler público** na tela.

![Journey Optimizer](./images/campaign2a.png)

Clique no ícone **editar** para selecionar um público-alvo.
...
Você deverá ver isso. Defina o **Namespace** como **Email**. Clique em **Salvar**.

![Journey Optimizer](./images/campaign3.png)

Em **Ações**, arraste e solte a ação **Email** na tela.

![Journey Optimizer](./images/campaign4.png)

Defina a **Categoria** como **Marketing** e selecione uma **Configuração** para **Email**. Clique em **Editar conteúdo**.

![Journey Optimizer](./images/campaign5.png)

Você verá isso. Clique no ícone **editar** ao lado da **linha de assunto**.

![Journey Optimizer](./images/campaign6.png)

Definir a linha de assunto como:
...
Você deverá ver isso. Em seguida, clique em **Editar corpo do email**.
...
Arraste e solte 2 vezes uma **coluna 1:1** na tela, o que deve fornecer esta estrutura:
