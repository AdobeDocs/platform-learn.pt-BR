...
## 2.1.5.2 Adicionar lógica e carregar dados de um endpoint externo

Para este exercício, você fará uma configuração &quot;bruta&quot; do Adobe Web SDK e solicitará a próxima melhor oferta do Adobe Journey Optimizer Offer Decisioning.
...
A biblioteca **alloy.js** é a biblioteca por meio do Web SDK, que torna possível enviar solicitações de um site para o Adobe Edge Network e de lá para aplicativos como o Adobe Experience Platform, Adobe Analytics, Adobe Target e muito mais.
...
A segunda tag de script (script2) carregará de forma assíncrona a biblioteca alloy.js do CDN de Adobe.
...
Esse bloco de código é usado para recuperar o valor da ID de Experience Cloud (ECID). A ECID é o identificador de dispositivo exclusivo do navegador.
...
Na solicitação, 2 **Escopos de Decisão** são especificados, o que solicitará que o Adobe Journey Optimizer Offer Decisioning forneça uma decisão sobre qual oferta precisa ser vista por esta ECID.
