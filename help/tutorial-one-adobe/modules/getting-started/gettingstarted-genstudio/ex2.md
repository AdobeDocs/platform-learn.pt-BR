...
![Armazenamento Azure](./images/ps2.png)

Selecione **Adobe Firefly Services** e escolha **Photoshop - Firefly Services**. Selecione **Próximo**.

![Armazenamento Azure](./images/ps3.png)

Selecione **Próximo**.

![Armazenamento Azure](./images/ps4.png)
...
![Armazenamento Azure](./images/ps5.png)
...
![Armazenamento Azure](./images/aep1.png)

Selecione **Adobe Experience Platform** e escolha **API Experience Platform**. Selecione **Próximo**.

![Armazenamento Azure](./images/aep2.png)

Selecione **Próximo**.

![Armazenamento Azure](./images/aep3.png)
...
![Armazenamento Azure](./images/aep4.png)
...
Ir para [Opção 1: configuração do Postman](./ex3.md){target="_blank"}

Ir para [Opção 2: configuração PostBuster](./ex4.md){target="_blank"}
