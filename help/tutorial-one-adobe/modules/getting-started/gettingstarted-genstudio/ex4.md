...
>[!IMPORTANT]
>
>Se você não for um funcionário da Adobe, siga as instruções para [instalar o Postman](./ex3.md){target="_blank"}. As instruções abaixo são destinadas apenas aos funcionários da Adobe.
...
Clique na versão correta para seu sistema operacional.
...
Vá para [Aplicativos a serem instalados](./ex5.md){target="_blank"}
