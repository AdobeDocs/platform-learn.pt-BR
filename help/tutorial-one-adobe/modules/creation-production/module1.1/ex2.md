---
title: Otimizar o processo do Firefly usando o Microsoft Azure e URLs pré-assinados
description: Saiba como otimizar o processo do Firefly usando o Microsoft Azure e URLs pré-assinados
role: Developer
level: Beginner
jira: KT-5342
doc-type: tutorial
...
Saiba como otimizar seu processo do Firefly usando o Microsoft Azure e URLs pré-assinados.
...
- Local de armazenamento: pode ser um local de bucket do AWS S3, um local da conta de armazenamento do Microsoft Azure com contêiner
...
Acesse [https://portal.azure.com](https://portal.azure.com){target="_blank"} e faça logon com sua conta da Azure. Se você não tiver um, use seu endereço de email pessoal para criar sua conta do Azure.

![Armazenamento Azure](./images/02azureportalemail.png){zoomable="yes"}

Depois de fazer logon, você verá a seguinte tela:

![Armazenamento Azure](./images/03azureloggedin.png){zoomable="yes"}
...
![Armazenamento Azure](./images/04azurestartsubscribe.png){zoomable="yes"}
...
![Armazenamento Azure](./images/06azuresubscriptionok.png){zoomable="yes"}

## 1.1.2.3 Criar Conta de Armazenamento do Azure

Procure por `storage account` e selecione **Contas de armazenamento**.

![Armazenamento Azure](./images/azs1.png){zoomable="yes"}

Selecione **+ Criar**.

![Armazenamento Azure](./images/azs2.png){zoomable="yes"}
...
![Armazenamento Azure](./images/azs3.png){zoomable="yes"}

Selecione **Criar**.

![Armazenamento Azure](./images/azs4.png){zoomable="yes"}

Após a confirmação, selecione **Ir para o recurso**.

![Armazenamento Azure](./images/azs5.png){zoomable="yes"}

Sua Conta de Armazenamento da Azure está pronta para ser usada.

![Armazenamento Azure](./images/azs6.png){zoomable="yes"}

Selecione **Armazenamento de dados** e vá para **Contêineres**. Selecione **+ Contêiner**.

![Armazenamento Azure](./images/azs7.png){zoomable="yes"}

Use `--aepUserLdap--` para o nome e selecione **Criar**.

![Armazenamento Azure](./images/azs8.png){zoomable="yes"}

Seu contêiner agora está pronto para ser usado.

![Armazenamento Azure](./images/azs9.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az10.png){zoomable="yes"}

Abra o aplicativo e selecione **Entrar com o Azure**.

![Armazenamento Azure](./images/az11.png){zoomable="yes"}

Selecione **Assinatura**.

![Armazenamento Azure](./images/az12.png){zoomable="yes"}

Selecione **Azure** e depois **Próximo**.

![Armazenamento Azure](./images/az13.png){zoomable="yes"}

Selecione sua conta do Microsoft Azure e conclua o processo de autenticação.

![Armazenamento Azure](./images/az14.png){zoomable="yes"}

Após a autenticação, essa mensagem é exibida.

![Armazenamento Azure](./images/az15.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az16.png){zoomable="yes"}

Sua conta de armazenamento aparece em **Contas de Armazenamento**.

![Armazenamento Azure](./images/az17.png){zoomable="yes"}

Abra **Contêineres de blob** e selecione o contêiner criado no exercício anterior.

![Armazenamento Azure](./images/az18.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az26.png){zoomable="yes"}
...
No Azure Storage Explorer, clique com o botão direito em seu contêiner e selecione **Obter Assinatura de Acesso Compartilhado**.

![Armazenamento Azure](./images/az27.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az28.png){zoomable="yes"}

Depois de receber sua **Assinatura de Acesso Compartilhado**, selecione **Copiar** para copiar a URL.

![Armazenamento Azure](./images/az29.png){zoomable="yes"}

Use a **URL do token SAS** para carregar um arquivo para sua Conta de Armazenamento da Azure.
...
![Armazenamento Azure](./images/az30.png){zoomable="yes"}

Altere o nome da solicitação vazia para **Carregar arquivo para a Conta de Armazenamento da Azure**, altere o **Tipo de Solicitação** para **PUT** e cole a URL do token SAS na seção de URL e selecione **Corpo**.

![Armazenamento Azure](./images/az31.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az32.png){zoomable="yes"}

Selecione o arquivo de sua escolha e selecione **Abrir**.

![Armazenamento Azure](./images/az33.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az34.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az34a.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az102.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az103.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az104.png){zoomable="yes"}
...
![Armazenamento Azure](./images/az105.png){zoomable="yes"}
...
![Armazenamento Azure](./images/pbbe1.png)

Em seguida, você verá quatro variáveis vazias. Insira os detalhes da sua conta de armazenamento da Azure aqui.

![Armazenamento Azure](./images/pbbe2.png)

Agora, seu arquivo de Ambiente base deve ter esta aparência. Clique em **Fechar**.

![Armazenamento Azure](./images/pbbe3.png)
...
![Armazenamento Azure](./images/az106.png){zoomable="yes"}

Se as variáveis foram configuradas corretamente, um URL de imagem será retornado.

![Armazenamento Azure](./images/az107.png){zoomable="yes"}

Abra o URL da imagem para verificar sua imagem.

![Armazenamento Azure](./images/az108.jpg)
