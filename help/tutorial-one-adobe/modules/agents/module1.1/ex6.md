...
Adicione a si mesmo ao grupo abaixo usando o IAM para obter acesso às credenciais do LLM.

>[!NOTE]
>
>Algumas das instruções abaixo são específicas do Adobe. Pergunte ao seu representante da Adobe sobre o GRP a ser usado.
...
>[!NOTE]
>
>Os comandos abaixo exigem que um URL específico seja usado. Pergunte ao representante da Adobe sobre o URL a ser usado.
...
Verifique se sua instância está definida para usar a instância **Experience Platform International** e a sandbox **Accelerate**.
...
## 1.1.6.5 Correlacionar pedidos com preferências de conteúdo
...
## 1.1.6.6 Identificar Jornadas de Fibra Existentes
...
## 1.1.6.7 Verifique qual público-alvo é usado
...
## 1.1.6.8 Validar o desempenho da jornada através da análise de fallout
...
Revise o plano. Clique em **Aceitar plano**.
...
## 1.1.6.10 Encontre públicos-alvo existentes alinhados a alto uso e verifique se eles estão em uso
...
## 1.1.6.11 Criar nova Jornada para lançamento de máximo de fibra
...
## 1.1.6.12 Gerenciamento de Conflitos de Jornada
