...
Após 20-30min, seu modelo agora é treinado e pode ser publicado. Clique em **Publish**.
...
Depois que o modelo personalizado for treinado, ele também poderá ser usado por meio da API. No exercício 1.1.1, você já configurou o projeto do Adobe I/O para interação com os Serviços do Firefly por meio da API.
...
Para acessar um Modelo Personalizado de Firefly, o Modelo Personalizado precisa ser compartilhado com a **ID de Conta Técnica** do nosso Projeto Adobe I/O.
...
## 1.1.4.4 Interagir com a API de modelos personalizados do Firefly Services

>[!IMPORTANT]
>
>Se você for um funcionário da Adobe, siga as instruções aqui para usar o [PostBuster](./../../../postbuster.md).

No Exercício 1.1.1 Introdução aos Serviços Firefly, você baixou este arquivo: [postman-ff.zip](./../../../assets/postman/postman-ff.zip) para o desktop local e importou essa coleção para o Postman.
