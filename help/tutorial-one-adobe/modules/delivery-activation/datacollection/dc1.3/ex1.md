---
title: Coleta de dados - FAC - Configuração da conta do Snowflake
description: Foundation - FAC - Configuração da conta do Snowflake
kt: 5342
doc-type: tutorial
...
# 1.3.1 Configurar o ambiente do Snowflake

## 1.3.1.1 Crie sua conta
...
Em seguida, você será conectado ao Snowflake. Clique em **Ignorar por agora**.

![FAC](./images/sf7.png)

## 1.3.1.2 Criar seu banco de dados
...
### Tabela `--aepUserLdap--_HOUSEHOLDS`
...
### Tabela `--aepUserLdap--_MONTHLY_DATA_USAGE`
...
### Tabela `--aepUserLdap--_MOBILE_DATA_USAGE`
...
Clique em **+ Criar** e selecione **Planilha SQL**.
...
Copie a consulta abaixo e cole-a na planilha do Snowflake.
...
Isto levará alguns minutos, e vocês verão isto depois.

![FAC](./images/dataload4.png)

Agora você tem dados de demonstração carregados no banco de dados do Snowflake. Fique à vontade para explorar os dados ali, abrindo qualquer tabela

Agora você concluiu a configuração no Snowflake.

![FAC](./images/dataload5.png)

## Próximas etapas

Ir para [1.3.2 Criar esquemas, modelo de dados e links](./ex2.md){target="_blank"}
