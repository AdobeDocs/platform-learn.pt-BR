...
- Adobe Firefly Services, Adobe Photoshop, E/S de estrutura Adobe, Preparação do Adobe Substance 3D
- Fluxo de trabalho do Adobe Workfront, Adobe Workfront Planning &amp; Adobe Workfront Fusion
...
![Adobe Qualificado](./assets/images/badge.png){width="100px" align="left"}
...
[1.1 Planejamento do Adobe Workfront](./modules/workflow-planning/module1.1/wfplanning.md){target="_blank"}
...
[1.1 Visão geral do Adobe Firefly Services](./modules/creation-production/module1.1/firefly-services.md){target="_blank"}
...
[1.6 GenStudio for Performance Marketing - Extensibilidade](./modules/creation-production/module1.6/genstudioext.md){target="_blank"}
...
[1.3 Adobe Experience Manager Forms com Edge Delivery Services](./modules/asset-mgmt/module1.3/aemforms.md){target="_blank"}

Neste módulo, você explorará o Adobe Experience Manager Forms com o Edge Delivery Services.

[1.4 Adobe Experience Manager Assets e Dynamic Media](./modules/asset-mgmt/module1.4/aemassetsdm.md){target="_blank"}

Neste módulo, você configurará o AEM Assets Dynamic Media e usará seu modelo do Dynamic Media no Adobe Journey Optimizer.
...
[3.3 Adobe Journey Optimizer: Mensagens por push e no aplicativo](./modules/delivery-activation/ajo-b2c/ajob2c-3/ajopushinapp.md)

Neste módulo, você usará o Adobe Journey Optimizer para configurar notificações por push e mensagens no aplicativo.
...
[3.6 Adobe Journey Optimizer: gerenciamento de conteúdo](./modules/delivery-activation/ajo-b2c/ajob2c-6/ajocontent.md)

Neste módulo, você aprenderá a configurar e usar Cartões de conteúdo e Páginas de aterrissagem no Adobe Journey Optimizer e aprofundará a integração entre o Adobe Journey Optimizer e o GenStudio for Performance Marketing.

[3.7 Adobe Journey Optimizer: Decisão](./modules/delivery-activation/ajo-b2c/ajob2c-7/ajo-decisioning.md)

Neste módulo, você aprenderá a configurar e usar o Decisioning e Experiências baseadas em código no Adobe Journey Optimizer.

[3.8 Adobe Journey Optimizer: Campanhas](./modules/delivery-activation/ajo-b2c/ajob2c-8/ajocampaigns.md)

Neste módulo, você aprenderá a configurar e usar Campanhas no Adobe Journey Optimizer.
