---
title: Planejamento - Migrar o Target em aplicativos móveis da extensão do Target para a extensão Otimize
...
# Planejar a migração do Target para a extensão Otimizar

Antes de atualizar o Target da extensão do Target para a extensão Otimizar no aplicativo móvel, você deve avaliar a implementação atual.
...
Em seguida, analise a [comparação detalhada da extensão do Target e da extensão do Otimize](detailed-comparison.md) para obter uma melhor compreensão das diferenças técnicas e identificar áreas que exigem foco adicional.
