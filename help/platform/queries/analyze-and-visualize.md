...
description: Saiba como usar o Serviço de consultas da Adobe Experience Platform com ferramentas de visualização de dados externas usando um exemplo de análise de churn.
feature: Queries
role: Developer
level: Intermediate
jira: KT-10191
