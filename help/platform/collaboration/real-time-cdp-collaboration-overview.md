...
Para começar, entre em contato com o administrador do Adobe Experience Platform (AEP) para garantir que você tenha acesso apropriado para configurar as permissões do Real-Time CDP Collaboration, conforme descrito nos tutoriais subsequentes. Se não conseguir identificar o administrador do AEP, entre em contato com a Equipe de conta da Adobe.
