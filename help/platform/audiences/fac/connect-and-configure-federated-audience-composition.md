...
Saiba como se conectar ao data warehouse e configurar essa conexão para a Composição de público-alvo federado. Para obter mais informações, visite [Documentação de composição de público-alvo federado](https://experienceleague.adobe.com/pt-br/docs/federated-audience-composition/using/home){target="_blank"}.
