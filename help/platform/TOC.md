...
+ Introdução ao Real-Time CDP {#rtcdp}
   + [Visão geral resumida](rtcdp/understanding-the-real-time-customer-data-platform.md)
   + [Como usar o Real-Time CDP](rtcdp/understanding-the-real-time-customer-data-platform-user-interface.md)
   + [Demonstração completa](rtcdp/demo.md)
   + [Visão geral do B2B edition](rtcdp/b2b-overview.md)
   + [Orquestrar campanhas com o Marketo Engage](rtcdp/orchestrate-campaigns-with-marketo-engage.md)
+ [Introdução: arquitetos de dados e engenheiros de dados](https://experienceleague.adobe.com/pt-br/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ Assistente de IA {#ai-assistant}
   ...
   + [Interface do Agent Orchestrator](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   ...
   + [Agente de suporte ao produto](/help/platform/ai-assistant/product-support-agent.md)
...
+ APIs {#api}
   + [Autenticar para APIs do Experience Platform](/help/platform/api/platform-api-authentication.md)
   + [Gerar um token de acesso](/help/platform/api/generate-an-access-token.md)
   + [Uso de APIs](/help/platform/api/use-apis-with-postman.md)
+ Públicos-alvo e segmentação {#audiences}
   + Audience Builder{#audience-builder}
      + [Introdução](audiences/audience-builder/introduction-to-audience-portal-and-composition.md)
      + [Fazer upload de públicos](audiences/audience-builder/upload-audiences.md)
      ...
      + [Demonstração da segmentação por transmissão](/help/platform/audiences/audience-builder/streaming-segmentation-demo.md)
      + [Avaliar públicos-alvo em lote sob demanda](/help/platform/audiences/audience-builder/evaluate-audiences-on-demand.md)
   + Composição de público-alvo federado {#fac}
      + [Visão geral](audiences/fac/overview-of-federated-audience-composition.md)
      + [Configurar uma conexão federada](audiences/fac/connect-and-configure-federated-audience-composition.md)
      + [Conectar-se ao Oracle](audiences/fac/connect-to-oracle.md)
      + [Criar um público-alvo federado](audiences/fac/create-a-federated-audience-composition.md)
      + [Assinatura de alertas](audiences/fac/subscribe-to-alerts.md)
   + Correspondência de segmentos{#segment-match}
      + [Configuração da conexão de Correspondência de segmentos](/help/platform/audiences/segment-match/segment-match-connection-setup.md)
      + [Governança de dados da Correspondência de segmentos](/help/platform/audiences/segment-match/segment-match-data-governance.md)
      + [Fluxo de configuração da Correspondência de segmentos](/help/platform/audiences/segment-match/segment-match-configuration-flow.md)
      + [Insights de pré-compartilhamento da correspondência de segmentos](/help/platform/audiences/segment-match/segment-match-pre-share-insights.md)
      + [Correspondências de segmentos recebendo dados](/help/platform/audiences/segment-match/segment-match-receiving-data.md)
   + Tutoriais{#audience-tutorials}
      + [Avaliar uma regra de público-alvo](https://experienceleague.adobe.com/pt-br/docs/experience-platform/segmentation/tutorials/evaluate-a-segment){target="_blank"}
      + [Criar um conjunto de dados para exportar dados](https://experienceleague.adobe.com/pt-br/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment){target="_blank"}
      + [Interagir com públicos-alvo do data warehouse](https://experienceleague.adobe.com/pt-br/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
+ [Logs de auditorisa](/help/platform/governance/audit-logs.md)
+ [Coleta de dados](https://experienceleague.adobe.com/pt-br/docs/platform-learn/data-collection/overview){target="_blank"}
+ Colaboração {#collaboration}
   + [Visão geral do Real-Time CDP Collaboration](collaboration/real-time-cdp-collaboration-overview.md)
   + [Introdução ao Collaboration](collaboration/real-time-cdp-collaboration-intro.md)
   + [Visão geral da Real-Time CDP para profissionais da agência](collaboration/rtcdp-overview-for-agency-practitioners.md)
   + [Collaboration - Processo e Pessoas](collaboration/rtcdp-collaboration-process-and-people.md)
   ...
   + [Criar um projeto](collaboration/create-a-project.md)
   + [Descobrir sobreposições de público](collaboration/discover-audience-overlaps-in-projects.md)
   + [Ativar públicos-alvo para colaboradores](collaboration/activate-audiences-in-projects.md)
   + [Medição do Collaboration - configuração e criação de relatórios](collaboration/collaboration-measurement-setup-and-report-creation.md)
   + [Marca para marca](collaboration/brand-to-brand-collaboration.md)
   + [Convidar parceiros a usar o Collaboration](collaboration/rtcdp-collaboration-in-product-invitations.md)
+ Painéis {#dashboards}
...
+ Assimilação de dados {#data-ingestion}
   ...
   + [Visão geral da ingestão em lote](/help/platform/data-ingestion/batch-ingestion-overview.md)
   ...
   + [Mapear um arquivo CSV para XDM](https://experienceleague.adobe.com/pt-br/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema){target="_blank"}
   + [Visão geral das fontes](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/overview)
   + [Assimilar dados do Adobe Analytics](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [Assimilar dados do Audience Manager](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [Assimilar dados do armazenamento na nuvem](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   + [Assimilar dados do CRM](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-crm)
   + [Assimilar dados de bancos de dados](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-databases)
   + [Visão geral da ingestão de streaming](/help/platform/data-ingestion/understanding-streaming-ingestion.md)
   + [Transmitir dados com a API HTTP](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [Dados de fluxo usando Conectores do Source](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
   + [Tutoriais do Web SDK](https://experienceleague.adobe.com/pt-br/docs/platform-learn/data-collection/web-sdk/overview){target="_blank"}
   + [Tutoriais do Mobile SDK](https://experienceleague.adobe.com/pt-br/docs/platform-learn/data-collection/mobile-sdk/overview){target="_blank"}
...
+ Destinos {#destinations}
   ...
   + [Configurar o destino do Marketo Engage](/help/platform/destinations/configure-the-marketo-destination.md)
   ...
   + Data Warehouse {#data-warehouse}
      + [Enviar dados do público-alvo para o lote de compartilhamento de dados do Snowflake](/help/platform/destinations/data-warehouse/send-audience-data-snowflake-batch.md)
...
+ Identidades {#identities}
   ...
   + Regras de vinculação do gráfico de identidade {#graph-linking-rules}
      ...
      + [Configurações de identidade](/help/platform/identities/identity-graph-linking-rules/identity-settings.md)
...
+ Monitoramento {#monitoring}
   ...
   + [Gerenciamento da capacidade de transmissão](monitoring/streaming-management.md)
   + [Integrar ao Slack](monitoring/monitor-events-in-slack.md)
...
+ Perfis {#profiles}
   ...
   + [Personalizar detalhes de exibição do perfil](https://experienceleague.adobe.com/pt-br/docs/experience-platform/profile/ui/profile-customization){target="_blank"}
...
+ Queries e Data Distiller {#queries}
   + [Visão geral](/help/platform/queries/understanding-query-service.md)
   + [Executar consultas](/help/platform/queries/run-queries.md)
   + [Validar dados](/help/platform/queries/explore-data.md)
   + [Derivar dados](/help/platform/queries/prepare-data.md)
   ...
   + [Analisar e visualizar dados no Tableau](/help/platform/queries/analyze-and-visualize.md)
...
+ Esquemas {#schemas}
   ...
   + [Planejar seu modelo de dados](/help/platform/schemas/plan-your-data-model.md)
   ...
   + [Criar um esquema ad hoc](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/tutorials/ad-hoc){target="_blank"}
+ Fontes {#sources}
...
+ Manuais de estratégia de casos de uso {#use-case-playbooks}
   ...
   + [Configurar uma sandbox de manual de estratégia](/help/platform/use-case-playbooks/configure-a-playbook-sandbox.md)
...
+ Integrações da Experience Cloud {#experience-cloud}
   + [Analytics](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [Audience Manager](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [Commerce](/help/platform/experience-cloud/business-value-of-platform-and-commerce.md)
   + [Marketo Engage](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/rtcdp/orchestrate-campaigns-with-marketo-engage)
