---
title: Enviar dados do público-alvo para o compartilhamento de dados da Snowflake - lote
description: Saiba como configurar e usar o destino em lote do Snowflake no Adobe Real-Time CDP para fornecer instantâneos diários de público-alvo com atualização completa na sua conta do Snowflake.
...
# Enviar dados do público-alvo para o compartilhamento de dados da Snowflake (lote)
