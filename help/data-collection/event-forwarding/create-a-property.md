...
Saiba como criar uma propriedade de encaminhamento de eventos em Coleção de dados. Para obter mais informações, visite o [Criar uma documentação de propriedade do encaminhamento de eventos](https://experienceleague.adobe.com/docs/experience-platform/tags/event-forwarding/getting-started.html#create-an-event-forwarding-property).
