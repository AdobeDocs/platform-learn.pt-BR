...
Parâmetros de entidade são parâmetros especiais usados em [implementações do Recomendações](https://experienceleague.adobe.com/docs/target/using/recommendations/plan-implement.html?lang=pt-BR) por três motivos principais:
