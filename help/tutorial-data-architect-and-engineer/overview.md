...
* Captura de dados da Web com o Adobe Experience Platform Web SDK
...
* Você assistiu à [Introdução à lista de reprodução do Adobe Experience Platform](https://experienceleague.adobe.com/pt-br/playlists/experience-platform-introduction) no Experience League e está familiarizado com os recursos da plataforma
