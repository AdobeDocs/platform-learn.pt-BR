...
No Xcode na origem de **[!UICONTROL AppDelegate]** e **[!UICONTROL MobileSDK]**, adicione as seguintes importações.
...
1. Adicione o seguinte código destacado à `application(_, didFinishLaunchingWithOptions)` função.
