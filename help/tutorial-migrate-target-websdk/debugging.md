---
title: Depurar | Migração do Target da at.js 2.x para o SDK da Web
...
![Elementos específicos do público alvo do corpo de resposta do SDK da Web da plataforma](assets/target-response.png){zoomable="yes"}
