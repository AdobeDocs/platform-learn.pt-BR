...
| Eventos Personalizados | Suportado | Parcialmente compatível por meio de [anzóis de monitoramento](https://github.com/adobe/alloy/wiki/Monitoring-Hooks) |
...
| Eventos personalizados da at.js | Não suportado. No entanto, [tokens de resposta](https://experienceleague.adobe.com/docs/experience-platform/edge/personalization/adobe-target/accessing-response-tokens.html) são expostas como parte da `propositions` na resposta do `sendEvent` chame. |
