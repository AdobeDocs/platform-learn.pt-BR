...
Uma ferramenta mais robusta para validação de dados é o [serviço de consulta](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/queries/explore-data) da Platform.
