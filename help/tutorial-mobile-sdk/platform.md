---
title: Enviar dados para a Experience Platform com o Platform Mobile SDK
...
Esta lição opcional é relevante para todos os clientes do Real-Time Customer Data Platform (Real-Time CDP), Journey Optimizer e Customer Journey Analytics. O Experience Platform, a base dos produtos da Experience Cloud, é um sistema aberto que transforma todos os seus dados (Adobe e não-Adobe) em perfis robustos de clientes. Esses perfis do cliente são atualizados em tempo real e usam insights orientados por IA para ajudar você a fornecer as experiências certas em cada canal.
...
![Arquitetura](assets/architecture-aep.png){zoomable="yes"}
...
1. Selecione **[!UICONTROL Criar conjunto de dados do esquema]**.
   ![início do conjunto de dados](assets/dataset-create.png){zoomable="yes"}
...
1. Selecione **[!UICONTROL Próximo]**.
   ![configuração de conjunto de dados](assets/dataset-configure.png){zoomable="yes"}

1. Forneça um **[!UICONTROL Nome]**, por exemplo `Luma Mobile App Events Dataset` e uma **[!UICONTROL Descrição]**.

1. Selecione **[!UICONTROL Concluir]**.
   ![término do conjunto de dados](assets/dataset-finish.png){zoomable="yes"}


## Adicionar serviço de sequência de dados do Adobe Experience Platform

Para enviar seus dados XDM da Edge Network para o Adobe Experience Platform, adicione o serviço Adobe Experience Platform à sequência de dados configurada como parte de [Criar uma sequência de dados](create-datastream.md).
...
1. Selecione **[!UICONTROL Salvar]**.
   ...
   ![Adicionar o Adobe Experience Platform como um serviço de sequência de dados](assets/datastream-service-aep.png){zoomable="yes"}
1. A configuração final deve ser semelhante a esta.

   ![configurações de sequência de dados](assets/datastream-settings.png){zoomable="yes"}


## Validar dados no conjunto de dados

Agora que você criou um conjunto de dados e atualizou seu fluxo de dados para enviar dados para a Experience Platform, todos os dados XDM enviados para a Platform Edge Network são encaminhados para a Platform e chegam ao conjunto de dados.
...
![validar lotes do conjunto de dados da plataforma de aterrissagem de dados](assets/platform-dataset-batches.png){zoomable="yes"}

Você também deve ver registros e campos de exemplo usando o recurso **[!UICONTROL Visualizar conjunto de dados]**:
![validar ciclo de vida enviado ao conjunto de dados da plataforma](assets/lifecycle-platform-dataset.png){zoomable="yes"}

Uma ferramenta mais robusta para validação de dados é o [serviço de consulta](https://experienceleague.adobe.com/pt-br/docs/platform-learn/tutorials/queries/explore-data) da Platform.

## Ativar o Perfil do cliente em tempo real

O Perfil do cliente em tempo real da Experience Platform permite criar uma visualização integral de cada cliente individual que combina dados de vários canais, inclusive dados online, offline, de CRM e de terceiros. O Perfil permite consolidar dados diferentes do cliente em uma visualização unificada, oferecendo uma conta acionável com carimbo de data e hora de cada interação com o cliente.

### Ativar o esquema

1. Abra seu esquema, por exemplo **[!DNL Luma Mobile App Event Schema]**.
1. Habilitar **[!UICONTROL Perfil]**.
1. Selecione **[!UICONTROL Os dados deste esquema contêm uma identidade primária no campo identityMap.]** no diálogo.
1. **[!UICONTROL Salve]** o esquema.

   ![habilitar o esquema para o perfil](assets/platform-profile-schema.png){zoomable="yes"}
...
1. Habilitar **[!UICONTROL Perfil]**.
   ...
   ![habilitar o conjunto de dados para o perfil](assets/platform-profile-dataset.png){zoomable="yes"}
...
![obter um valor de identidade](assets/platform-identity.png){zoomable="yes"}
...
![pesquisar um valor de identidade](assets/platform-profile-lookup.png){zoomable="yes"}
...
![detalhes do perfil](assets/platform-profile-details.png){zoomable="yes"}
...
1. Para pesquisar o valor de identidade, especifique `Luma CRM ID` como o **[!UICONTROL Namespace de identidade]** e o valor copiado como o **[!UICONTROL Valor de identidade]**. Em seguida, selecione **[!UICONTROL Exibir]**.
   ...
   Esta visualização mostra as identidades que estão vinculadas em um perfil e suas origens. Este é um exemplo de um gráfico de identidade construído com dados coletados ao concluir este tutorial do Mobile SDK (Data Source 2) e o [tutorial do Web SDK](https://experienceleague.adobe.com/pt-br/docs/platform-learn/implement-web-sdk/overview) (Data Source 1):

   ![obter um valor de identidade](assets/platform-profile-identitygraph.png){zoomable="yes"}


## Próximas etapas

Há muito mais que os profissionais de marketing e análise podem fazer com dados capturados no Experience Platform, incluindo analisá-los no Customer Journey Analytics e criar segmentos no Real-Time Customer Data Platform. Você está indo para um bom começo!


>[!SUCCESS]
>
>Agora você configurou o aplicativo para enviar dados não apenas para a Edge Network, mas também para o Adobe Experience Platform.<br>Obrigado por investir seu tempo na aprendizagem sobre o Adobe Experience Platform Mobile SDK. Se tiver dúvidas, quiser compartilhar comentários gerais ou tiver sugestões sobre conteúdo futuro, compartilhe-os nesta [postagem de discussão da Comunidade Experience League](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-platform-data/tutorial-discussion-implement-adobe-experience-cloud-in-mobile/td-p/443796?profile.language=pt).
>
